...
function Trading() {
  ...
  return (
    <div className="flex flex-col min-h-screen">
      ...
      <PageBanner
        title="Trading"
        subtitle="CFT offers a comprehensive platform for all your trading needs. From equities to commodities, explore the diverse range of financial instruments."
      />
