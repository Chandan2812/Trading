import worldGraph from "../assets/newabout.webp";
      ...
      <section>
        ...
        <div className="flex flex-col lg:flex-row items-center justify-center mx-auto gap-5">
          ...
          <div className="w-full lg:w-1/2 mt-36 px-5">
            <h2 className="text-3xl font-bold mb-4">
              About{" "}
              <span className="text-[var(--primary-color)] dark:text-[var(--primary-color)]">
                Us
              </span>
            </h2>
            <p className="mb-4 text-gray-700 dark:text-gray-300 md:max-w-xl">
            ...
            <p className="mb-6 text-gray-600 dark:text-gray-400 md:max-w-xl">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 max-w-7xl mx-auto px-6 mt-12">
          {[
            ...
            "https://img.freepik.com/photos-premium/interieur-bureau-moderne_52137-8465.jpg?semt=ais_hybrid&w=740",
            "https://media.istockphoto.com/id/1372834292/photo/empty-workdesk-in-modern-office.jpg?s=170667a&w=0&k=20&c=db0VaxqtBqBwI_IyAPpCoZN_AOkGIRUBtkiSXuYGO08=",
          ].map((url, idx) => (
            <img
              key={idx}
              src={url}
        ...
        <div className="max-w-4xl mx-auto py-20 px-6">
          <div className="bg-gradient-to-br from-gray-100 to-white dark:from-[#111] dark:to-[#1a1a1a] border border-[var(--primary-color)] rounded-2xl text-center py-16 px-8">
