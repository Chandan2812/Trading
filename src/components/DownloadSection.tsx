...
export default function DownloadSection() {
  return (
    <div className="bg-black text-white px-6 py-12 md:py-20 md:px-20 flex flex-col md:flex-row items-center justify-between gap-10">
      {/* Left: Image */}
      ...
      <div className="md:w-1/2">
        ...
        <p className="text-gray-300 mb-6">
          ...
          <span className="font-semibold">1,500+ instruments</span>, and you can
          trade smoothly on any device you like.
          <br />
